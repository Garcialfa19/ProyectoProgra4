...
public class ServicioReceta extends Servicio implements Serializable {
    ...
    List<IngreTO> listaIngre = new ArrayList<IngreTO>(); //lista de ingredientes de la receta
    List<PasosTO> listaPasos = new ArrayList<PasosTO>(); //lista de pasos de la receta
    List<RecetaTO> listaRetorno = new ArrayList<RecetaTO>(); //lista de las recetas del usuario
    ...
    public List<RecetaTO> listaRecetas(int idUS_REC) {
        listaRetorno = new ArrayList<RecetaTO>();
        PreparedStatement pstmt = null;
        ResultSet rs = null;
