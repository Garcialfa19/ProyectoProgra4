...
public class PasosController implements Serializable{
    ...
    public List<Integer> listaPasos = new ArrayList<Integer>();
    ...
    public List<Integer> getListaPasos() {
        return listaPasos;
    }

    public void setListaPasos(List<Integer> listaPasos) {
